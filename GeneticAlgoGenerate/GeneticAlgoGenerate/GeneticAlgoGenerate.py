...
set.renameArguments(ARG1="last1")
set.renameArguments(ARG1="volume1")
set.renameArguments(ARG1="type1")
set.renameArguments(ARG0="bid2")
set.renameArguments(ARG1="ask2")
set.renameArguments(ARG1="last2")
set.renameArguments(ARG1="volume2")
set.renameArguments(ARG1="type2")
set.renameArguments(ARG0="bid3")
set.renameArguments(ARG1="ask3")
set.renameArguments(ARG1="last3")
set.renameArguments(ARG1="volume3")
set.renameArguments(ARG1="type3")
set.renameArguments(ARG0="bid4")
set.renameArguments(ARG1="ask4")
set.renameArguments(ARG1="last4")
set.renameArguments(ARG1="volume4")
set.renameArguments(ARG1="type4")
set.renameArguments(ARG0="bid5")
set.renameArguments(ARG1="ask5")
set.renameArguments(ARG1="last5")
set.renameArguments(ARG1="volume5")
set.renameArguments(ARG1="type5")
set.renameArguments(ARG0="bid6")
set.renameArguments(ARG1="ask6")
set.renameArguments(ARG1="last6")
set.renameArguments(ARG1="volume6")
set.renameArguments(ARG1="type6")
set.renameArguments(ARG0="bid7")
set.renameArguments(ARG1="ask7")
set.renameArguments(ARG1="last7")
set.renameArguments(ARG1="volume7")
set.renameArguments(ARG1="type7")
set.renameArguments(ARG0="bid8")
set.renameArguments(ARG1="ask8")
set.renameArguments(ARG1="last8")
set.renameArguments(ARG1="volume8")
set.renameArguments(ARG1="type8")
set.renameArguments(ARG0="bid9")
set.renameArguments(ARG1="ask9")
set.renameArguments(ARG1="last9")
set.renameArguments(ARG1="volume9")
set.renameArguments(ARG1="type9")
set.renameArguments(ARG0="bid10")
set.renameArguments(ARG1="ask10")
set.renameArguments(ARG1="last10")
set.renameArguments(ARG1="volume10")
set.renameArguments(ARG1="type10")
